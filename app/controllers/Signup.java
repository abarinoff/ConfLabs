...
import models.authentication.TokenAction;
import models.authentication.TokenAction.Type;
...
public class Signup extends Controller {
	...
	public static Result doForgotPassword() {
		...
		if (filledForm.hasErrors()) {
			...
			flash(Application.FLASH_MESSAGE_KEY,
					Messages.get(
							"reset_password.message.instructions_sent",
							email));
			...
			if (user != null) {
				...
				if (user.emailValidated) {
					...
					flash(Application.FLASH_MESSAGE_KEY,
							Messages.get("reset_password.message.email_not_verified"));
	...
	public static Result doResetPassword() {
		...
		if (filledForm.hasErrors()) {
			...
			try {
				...
				flash(Application.FLASH_MESSAGE_KEY,
						Messages.get("reset_password.message.no_password_account"));
			}
			...
			if (login) {
				...
				flash(Application.FLASH_MESSAGE_KEY,
						Messages.get("reset_password.message.success.auto_login"));
				...
				flash(Application.FLASH_MESSAGE_KEY,
						Messages.get("reset_password.message.success.manual_login"));
			}
	...
	public static Result verify(final String token) {
		...
		flash(Application.FLASH_MESSAGE_KEY,
				Messages.get("verify_email.success", email));
